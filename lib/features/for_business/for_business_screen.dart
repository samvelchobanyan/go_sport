...
import 'package:go_sport/features/for_business/widgets/service_card.dart';
          ...
          child: Column(
            children: [
              ...
              const ServiceCard(
                ...
                description: 'Get detailed insights and analytics for your content',
                price: '\$49/month',
              ),
              const SizedBox(height: 16),
              const ServiceCard(
                title: 'Custom Branding',
                description: 'Customize your brand with white-label solutions',
                price: '\$199/month',
              ),
              const SizedBox(height: 16),
              const ServiceCard(

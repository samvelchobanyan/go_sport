...
class PlaylistRepositoryMock implements PlaylistRepository {
  ...
  final List<Track> _armenianRockTracks = [
    ...
    Track(
      ...
      artistName: 'Dorians',
      imageUrl:
          'https://images.unsplash.com/photo-1453738773917-9c3eff1db985?auto=format&fit=crop&w=800&q=80',
    ...
    Track(
      ...
      artistName: 'Dorians',
      imageUrl:
          'https://images.unsplash.com/photo-1468164016595-6108e4c60c8b?auto=format&fit=crop&w=800&q=80',
    ...
    Track(
      ...
      imageUrl:
          'https://images.unsplash.com/photo-1524655683691-a2a35bfeded7?auto=format&fit=crop&w=800&q=80',
    ...
    Track(
      ...
      artistName: 'Rock Ensemble',
      imageUrl:
          'https://images.unsplash.com/photo-1541425786673-fef5c4e12736?auto=format&fit=crop&w=800&q=80',
    ...
    Track(
      ...
      artistName: 'Armenian Rock Collective',
      imageUrl:
          'https://images.unsplash.com/photo-1477233534935-f5e6fe7c1159?auto=format&fit=crop&w=800&q=80',
  ...
  Future<String?> toggleLike(String playlistId, [String? likeId]) async {
    ...
    if (index != -1) {
      ...
      if (likeId != null) {
        _featuredPlaylists[index] = playlist.copyWith(
          isLiked: false,
          likeId: null,
        );
        return null;
  ...
  Future<void> addPlaylist(String name) async {
    await Future.delayed(const Duration(milliseconds: 200));
    // Mock implementation - in a real app, this would add the playlist to the database
  }
}

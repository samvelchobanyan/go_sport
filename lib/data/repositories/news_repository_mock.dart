...
class MockNewsRepository implements NewsRepository {
  ...
  final List<NewsArticle> _mockData = [
    NewsArticle(
      id: '1',
      title: 'No panic - but is this Liverpool\'s transitional season coming a year late?',
      subtitle: 'Last year was not a Team transition it was a Coach transition. Klopp\'s team knew how to play together.',
      ...
      content: 'He could then make tactical suggestions when things weren\'t working. They listened, knew how to execute together and won the League.',
      likesCount: 35,
      isLiked: false,
    ),
    NewsArticle(
      id: '2',
      title: 'Premier League news conferences: Newcastle\'s Tonali touch and go for Fulham fixture',
    ...
    NewsArticle(
      ...
      content: 'Arsenal\'s defensive record this season has been exceptional...',
      likesCount: 28,
      isLiked: true,
    ),
    NewsArticle(
      id: '4',
      title: 'Manchester United\'s youth academy continues to produce world-class talent',
      ...
      content: 'Manchester United academy has been a breeding ground for exceptional talent...',
      likesCount: 42,
      isLiked: false,
    ),
    NewsArticle(
      ...
      content: 'The Champions League final promises to be an exciting tactical battle...',
      likesCount: 67,
      isLiked: true,
    ),
    NewsArticle(
      ...
      author: 'David Miller',
      imageUrl: 'https://images.unsplash.com/photo-1614632537239-d3d9e8a2e0b3?auto=format&fit=crop&w=800&q=80',
      publishedAt: DateTime(2025, 5, 5),
      content: 'Premier League clubs are eyeing several high-profile targets...',
      likesCount: 89,
      isLiked: false,
    ),
    NewsArticle(
      ...
      content: 'Women\'s football has seen unprecedented growth in recent years...',
      likesCount: 54,
      isLiked: false,
    ),
    NewsArticle(
      ...
      content: 'VAR continues to be a topic of heated discussion in football...',
      likesCount: 103,
      isLiked: true,
    ),
    NewsArticle(
      ...
      content: 'Barcelona has made remarkable strides in their financial recovery...',
      likesCount: 71,
      isLiked: false,
    ),
    NewsArticle(
      ...
      content: 'World Cup qualifying continues with crucial matches this week...',
      likesCount: 45,
      isLiked: false,
    ),
    NewsArticle(
      ...
      content: 'The Bundesliga title race is one of the tightest in recent memory...',
      likesCount: 58,
      isLiked: true,
    ),
    NewsArticle(
      ...
      author: 'Marco Rossi',
      imageUrl: 'https://images.unsplash.com/photo-1577471488278-16eec37ffcc2?auto=format&fit=crop&w=800&q=80',
    ...
    NewsArticle(
      ...
      content: 'Major League Soccer continues its expansion with three new teams...',
      likesCount: 41,
      isLiked: false,
    ),
    NewsArticle(
    ...
    NewsArticle(
      ...
      content: 'UEFA has unveiled plans for a new European competition structure...',
      likesCount: 78,
      isLiked: false,
    ),
    NewsArticle(
      ...
      imageUrl: 'https://images.unsplash.com/photo-1526948531399-320e7e40f0ca?auto=format&fit=crop&w=800&q=80',
    ...
    NewsArticle(
      id: '18',
      title: 'Premier League broadcasting rights: Record-breaking deal announced',
      subtitle: 'Biggest TV deal in sports history',
      author: 'Richard Taylor',
      imageUrl: 'https://images.unsplash.com/photo-1487466365202-1afdb86c764e?auto=format&fit=crop&w=800&q=80',
      publishedAt: DateTime(2025, 4, 23),
      content: 'The Premier League has secured a record-breaking broadcasting deal...',
      likesCount: 94,
      isLiked: true,
    ),
    NewsArticle(
      ...
      author: 'Sophie Green',
      imageUrl: 'https://images.unsplash.com/photo-1472887256648-e7d1c0f56a5e?auto=format&fit=crop&w=800&q=80',
      publishedAt: DateTime(2025, 4, 22),
      content: 'Football clubs are embracing sustainability and environmental responsibility...',
      likesCount: 29,
      isLiked: false,
    ),
    NewsArticle(
  ...
  Future<void> toggleLike(String id) async {
    ...
    if (index != -1) {
      ...
      _mockData[index] = article.copyWith(
